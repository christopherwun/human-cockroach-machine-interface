...
class Cortex(Dispatcher):
    ...
    def open(self):
        ...
        print("Threads before starting websock_thread: ", threading.enumerate())
        self.websock_thread.start()

        print("Threads after starting websock_thread: ", threading.enumerate())
        self.websock_thread.join()

        print("Threads after joining websock_thread: ", threading.enumerate())
